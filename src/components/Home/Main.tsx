  ...
  return (
    <Box sx={mainWrapperStyles}>
      <Box sx={mainUpperButtonsStyles}>
        <Button
          variant="contained"
          sx={form100ButtonStyles}
          onClick={openForm100Dialog}
        >
          <Typography variant="h4">{Forms.FORM_100}</Typography>
          <Typography sx={buttonDescStyles}>
            Створіть або перегляньте форму для поранених чи хворих
            військовослужбовців.
          </Typography>
        </Button>
        <Box sx={searchButtonStyles}>
          ...
          >
            <Typography variant="h5">Швидкий Пошук</Typography>
            <Typography sx={buttonDescStyles}>
          ...
          >
            <Typography variant="h5">Перелік Поранених</Typography>
            <Typography sx={buttonDescStyles}>
      ...
      <Box sx={mainLowerButtonsStyles}>
        <Button
          ...
          color="secondary"
          sx={mainButtonStyles}
          onClick={openConclusionFormDialog}
        >
        ...
        <Button
          ...
          color="secondary"
          sx={mainButtonStyles}
          onClick={openDischargeFormDialog}
        >
          <Typography variant="h5">{Forms.DISCHARGE}</Typography>
        </Button>
        <Button
          variant="contained"
          color="secondary"
        ...
        >
          <Typography variant="h5">{Forms.REFERRAL}</Typography>
        </Button>
      </Box>
      {Form100Dialog}
      {PersonDialog}
